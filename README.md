...
4. 최신 코드가 특정 브랜치에 있다면 브랜치명을 입력합니다. 비워두면 기본 `HEAD` 기준으로 분석합니다.
5. private 저장소라면 GitHub token을 입력합니다.
6. 포스트 유형을 선택하고 초안 생성을 실행합니다.
...
입력한 브랜치가 저장소에 없으면 `입력한 브랜치를 찾을 수 없습니다` 메시지를 표시합니다.
